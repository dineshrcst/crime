...
<thead>
	 <tr>
    <th class="text-center">POLICE ID</th>
    <th class="text-center">NAME</th>
    <th class="text-center">ADDRESS</th>
    <th class="text-center">PHONE NO</th>
    <th class="text-center">EMAIL</th>
    <th class="text-center">DISTRICT</th>
    <th class="text-center">OIC</th>
...
<td class="text-center">
<span class="ap-tabledata-export"><?php echo $item->district; ?></span>
</td>
<td class="text-center">
<span class="ap-tabledata-export"><?php echo $item->name1." ".$item->name2; ?></span>
</td>
<td class="text-center">
	<center>
	    <form method="post" name ="assignPolice" action="<?php echo $this->config->item('base_url')."Police/updatePolice";?>"> 
        <input type="hidden" name="id" value="<?php echo $item->id; ?>">
	    <button type="submit" class="btn btn-primary btn-update" >EDIT
	    </button>
     
      <button type="button"  class="btn btn-danger" value="<?php echo $item->id; ?>" data-toggle="modal" data-target="#delModal" data-href="<?php echo $this->config->item('base_url')."Police/deleteData";?>?id=<?php echo $item->id; ?>">DELETE
      </button>
      </form>
    </center>
</td>
