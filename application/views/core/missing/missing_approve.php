...
<td class="text-center">
	<center>
	    <button type="button"  class="btn btn-primary" value="<?php echo $item->id; ?>" data-toggle="modal" data-target="#confModal" data-href="<?php echo $this->config->item('base_url')."Missing/approveData";?>?id=<?php echo $item->id; ?>">APPROVE
	    </button>
...
$(function() {
  ...
  $("form[name='rejectPerson']").validate({
