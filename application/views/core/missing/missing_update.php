...
<form id="requestform" enctype="multipart/form-data" class="col-md-6 app-tab-pane-content-form ap-padding-0 " tabindex="-1" method="post" action="<?php echo $this->config->item('base_url')."missing/update";?>"">
...
<div class="col-md-8 ap-sinp-col-for-inp-1">
<textarea id="id-address" class="form-control ap-inp-field" name="address" cols="50" rows="5" placeholder="Enter missing person address here..." tabindex="2" minlength="1" maxlength="100">
...
<div class="col-md-8 ap-sinp-col-for-inp-1">
<textarea id="id-description" class="form-control ap-inp-field" name="description" cols="50" rows="5" placeholder="Enter brief description about missing person here..." tabindex="3" minlength="1" maxlength="100"><?php echo $list[0]->description;?></textarea>
...
<div class="col-md-8 ap-sinp-col-for-inp-1">
<input id="id-phone" class="form-control ap-inp-field" type="text" name="phone" autocomplete="off" autocorrect="off" spellcheck="false"  tabindex="5" value = "<?php echo $list[0]->contact;?>" >
...
<script type="text/javascript">
    ...
    onSelect: function(dateText, inst) {
     ...
     $('#datepicker').datepicker('setDate', '<?php echo $list[0]->missing_from;?>');
    });
