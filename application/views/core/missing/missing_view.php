...
<div class="container">
  ...
  $count = 0;  ?> 
    <?php foreach ($list as $item):  
      $path = $this->config->item('base_url')."uploads/missing/";
       $count =  $count +1;
      ?>
        ...
        <div class="row">
          ...
          <span id = "pAddress_<?php echo $count;?>" value="<?php echo $item->address;?>"></span>
          <span id = "pDesc_<?php echo $count;?>" value="<?php echo $item->description;?>"></span>
          <span id = "mFrom_<?php echo $count;?>" value="<?php echo $item->missing_from;?>"></span>
          <span id = "phone_<?php echo $count;?>" value="<?php echo $item->phone;?>"></span>
...
function showDetails(count){
  ...
  var address = $('#pAddress_'+count).attr('value');
  var description = $('#pDesc_'+count).attr('value');
  var missingFrom = $('#mFrom_'+count).attr('value');
  var phone = $('#phone_'+count).attr('value');
  ...
  html += "<div class='form-group row'>";
  html += "<label class='col-sm-2 col-form-label'>Address</label>";
  html += "<div class='col-sm-10'>";
  html += "<textarea class='form-control' readonly rows='3'>"+address+"</textarea>";
  html += "</div>";
  html += "</div>";

  html += "<div class='form-group row'>";
  html += "<label class='col-sm-2 col-form-label'>Description</label>";
  html += "<div class='col-sm-10'>";
  html += "<textarea class='form-control' readonly rows='3'>"+description+"</textarea>";
  html += "</div>";
  html += "</div>";

  html += "<div class='form-group row'>";
  html += "<label class='col-sm-2 col-form-label'>Missing From</label>";
  html += "<div class='col-sm-10'>";
  html += "<input type='text' readonly class='form-control-plaintext' value='"+missingFrom+"'>";
  html += "</div>";
  html += "</div>";

  html += "<div class='form-group row'>";
  html += "<label class='col-sm-2 col-form-label'>Contact No</label>";
  html += "<div class='col-sm-10'>";
  html += "<input type='text' readonly class='form-control-plaintext' value='"+phone+"'>";
  html += "</div>";
  html += "</div>";
