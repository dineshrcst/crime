...
<td class="text-center">
<span class="ap-tabledata-export"><?php echo $item->age; ?></span>
</td>

<td class="text-center">
<span class="ap-tabledata-export"><?php echo $item->sex; ?></span>
</td>

<td class="text-center">
<span class="ap-tabledata-export"><?php echo $item->aliases; ?></span>
</td>

<td class="text-center">
<span class="ap-tabledata-export"><?php echo $item->remarks; ?></span>
</td>

<td class="text-center">
<span class="ap-tabledata-export"><?php echo $item->caution; ?></span>
</td>
...
<td class="text-center">
  <center>
      <form method="post" name ="updatePerson" action="<?php echo $this->config->item('base_url')."Wanted/updatePerson";?>"> 
        <input type="hidden" name="comId" value="<?php echo $item->id; ?>">
      <button type="submit" class="btn btn-primary btn-update" >EDIT
      </button>
     
      <button type="button"  class="btn btn-danger" value="<?php echo $item->id; ?>" data-toggle="modal" data-target="#delModal" data-href="<?php echo $this->config->item('base_url')."Wanted/deleteData";?>?id=<?php echo $item->id; ?>">DELETE
      </button>
      </form>
    </center>
</td>
