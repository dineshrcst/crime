...
<form id="requestform" enctype="multipart/form-data" class="col-md-6 app-tab-pane-content-form ap-padding-0 " tabindex="-1" method="post" action="<?php echo $this->config->item('base_url')."complain/update";?>"">   
...
<li>
    ...
    $('#datepicker').datepicker('setDate', '<?php echo $list[0]->date;?>');
    $('#ctime').val('<?php echo $list[0]->time;?>');
    });
    </script>
...
<div class="col-md-8 ap-sinp-col-for-inp-1">
<textarea id="id-address" class="form-control ap-inp-field" name="address" cols="50" rows="5" placeholder="Enter criminal address here..." tabindex="4" minlength="1" maxlength="100"><?php echo $list[0]->address;?> </textarea>
...
<div class="col-md-8 ap-sinp-col-for-inp-1">
<textarea id="id-description" class="form-control ap-inp-field" name="description" cols="50" rows="5" placeholder="Enter brief description about crime here..." tabindex="5" minlength="1" maxlength="100"><?php echo $list[0]->description;?>
</textarea>
...
<div class="col-md-8 ap-sinp-col-for-inp-1">
<input id="id-wname1" class="form-control ap-inp-field" type="text" name="wname1" autocomplete="off" autocorrect="off" spellcheck="false"  tabindex="6" value = "<?php echo $list[0]->withness_name_1;?>">
</div>
</div>
</div>
</div>
...
<input id="id-wphone1" class="form-control ap-inp-field numeric_only" type="text" name="wphone1" autocomplete="off" autocorrect="off" spellcheck="false" tabindex="7" value = "<?php echo $list[0]->withness_phone_1;?>">
...
<div class="col-md-8 ap-sinp-col-for-inp-1">
<input id="id-wname2" class="form-control ap-inp-field" type="text" name="wname2" autocomplete="off" autocorrect="off" spellcheck="false"  tabindex="8" value = "<?php echo $list[0]->withness_name_2;?>">
</div>
</div>
</div>
</div>
...
<div class="col-md-4 ap-sinp-col-for-inp-1">
<input id="id-wphone2" class="form-control ap-inp-field numeric_only" type="text" name="wphone2" autocomplete="off" autocorrect="off" spellcheck="false" tabindex="9" value = "<?php echo $list[0]->withness_phone_2;?>">
...
<div>
<div class="col-md-4 ap-sinp-col-for-lbl">
<label class="ap-lbl-inp-txt" for="input-name">Nearest Police Station: </label>
</div> 
...
<?php if($pc->id == $list[0]->near_police ){ ?>
...
<script type="text/javascript">
 ...
 function showPosition(position) {
    var latitude = <?php echo $list[0]->latitude;?>;
    var longitude = <?php echo $list[0]->longitude;?>;
