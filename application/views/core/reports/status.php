...
<form id="requestform" class="col-md-8 app-tab-pane-content-form ap-padding-0 " tabindex="-1" method="post" action="<?php echo $this->config->item('base_url')."reports/viewStatus";?>"">   
<div class="col-md-12 wid-no-padding">

<div class="row form-group app-form-group app-form-group-first">
<label class="app-input-label" style="margin-bottom:0px;"><b>Please Select Criminal Status</b></label>
<hr>
<br/>
</div>
...
<label class="ap-lbl-inp-txt" for="input-name">Criminal Status: <span class="app-req-star">*</span></label>
</div> 

<div class="col-md-8 ap-sinp-col-for-inp-1">
<select id="id-statusselector" class="selectpicker form-control ap-inp-field" name="statusselector" data-dropup-auto="false" data-size="5" data-live-search="false" data-show-subtext="true" title="Select criminal status" tabindex="2">
    <option value = "" selected>Select Criminal Status</option>
...
<span id="er-crimeselector" class="ap-lbl-inp-err" for="error-msg"><?php echo form_error('statusselector'); ?></span>
</div>
</div>
</div>
</div>
