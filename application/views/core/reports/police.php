...
<form id="requestform" class="col-md-8 app-tab-pane-content-form ap-padding-0 " tabindex="-1" method="post" action="<?php echo $this->config->item('base_url')."reports/viewPolice";?>"">   
...
<select id="id-policeselector" class="selectpicker form-control ap-inp-field" name="policeselector" data-dropup-auto="false" data-size="5" data-live-search="true" data-show-subtext="true" title="Select Police Stattion" tabindex="1">
<option value="0" data-subtext="Select Type" >Select Police Station</option>
<?php if (isset($districts)): ?>

<?php foreach ($districts as $disc): ?>
<?php if (isset($list) && $list[0]->police_station == $disc->name) : ?>
