  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLabel"><b>Reject User</b></h4>
      ...
      <div class="modal-body">
        ...
        <form method="post" name ="rejectComplain" action="<?php echo $this->config->item('base_url')."User/rejectData";?>">
          <br/>
          <input type="hidden" id="userId" name = "userId" class="form-control" id="recipient-name">
