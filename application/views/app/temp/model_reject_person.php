  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLabel"><b>Reject Person</b></h4>
      ...
      <div class="modal-body">
        ...
        <form method="post" name ="rejectPerson" action="<?php echo $this->config->item('base_url')."Missing/rejectData";?>">
          <br/>
